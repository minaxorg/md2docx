...
/**
 * Handler for fontColor nodes (created from <font color="..."> tags)
 * @param {object} ctx - context
 * @param {object} node - mdast node with color property
 * @returns {Array} array of TextRun objects with color applied
 */
export default async function fontColor(ctx, node) {
  const { color } = node;
